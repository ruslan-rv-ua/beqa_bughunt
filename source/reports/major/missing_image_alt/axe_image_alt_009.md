...
report_id: image_alt_009
severity: major
title: image_alt_009
summary: Відсутній альтернативний текст у зображення з селектором `img[imgfield="tn_img_1642339014010"]`
---
# Bug report `image_alt_009`
...
2|користуючись DevTools знайди зображення з наступним CSS-селектором: `img[imgfield="tn_img_1642339014010"]`
<!-- 3|переконайся що вказане зображення має текстову альтернативу -->

## Expected result

Зображення з CSS-селектором `img[imgfield="tn_img_1642339014010"]` має текстову альтернативу. 
Її значення:
...
У зображення з CSS-селектором `img[imgfield="tn_img_1642339014010"]` 
