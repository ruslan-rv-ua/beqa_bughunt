...
report_id: image_alt_001
severity: major
title: image_alt_001
summary: Відсутній альтернативний текст у зображення з селектором `img[imgfield="tn_img_1642340072152"]`
---
# Bug report `image_alt_001`
...
2|користуючись DevTools знайди зображення з наступним CSS-селектором: `img[imgfield="tn_img_1642340072152"]`
<!-- 3|переконайся що вказане зображення має текстову альтернативу -->

## Expected result

Зображення з CSS-селектором `img[imgfield="tn_img_1642340072152"]` має текстову альтернативу. 
Її значення:
...
У зображення з CSS-селектором `img[imgfield="tn_img_1642340072152"]` 
