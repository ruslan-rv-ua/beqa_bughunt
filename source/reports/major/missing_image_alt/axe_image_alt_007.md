...
report_id: image_alt_007
severity: major
title: image_alt_007
summary: Відсутній альтернативний текст у зображення з селектором `img[imgfield="tn_img_1642337656766"]`
---
# Bug report `image_alt_007`
...
2|користуючись DevTools знайди зображення з наступним CSS-селектором: `img[imgfield="tn_img_1642337656766"]`
<!-- 3|переконайся що вказане зображення має текстову альтернативу -->

## Expected result

Зображення з CSS-селектором `img[imgfield="tn_img_1642337656766"]` має текстову альтернативу. 
Її значення:
...
У зображення з CSS-селектором `img[imgfield="tn_img_1642337656766"]` 
